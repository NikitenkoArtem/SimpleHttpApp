...
CREATE TABLE commissions (
    ...
    CONSTRAINT CURRENCY_ID_COMMISSIONS_FK FOREIGN KEY (currency_id) REFERENCES currencies(currency_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE transfers (
    ...
    CONSTRAINT CURRENCY_ID_TRANSFERS_FK FOREIGN KEY (currency_id) REFERENCES currencies(currency_id) ON DELETE CASCADE ON UPDATE CASCADE,
